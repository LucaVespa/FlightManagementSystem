...
<html>
	...
	<body>
		...
		try {
			...
			"LEFT JOIN " +
    		"FlightTicketTransaction ftt ON r.ticketid = ftt.ticketid AND YEAR(ftt.purchaseDate) = 2022 AND MONTH(ftt.purchaseDate) = 11 " +
			"GROUP BY " +
    		"ac.twoLetterid " +
			"ORDER BY " +
			...
			out.print("Showing sales for month " + month + " of year " + year + ":");

...
<body>
	...
	if (flightId.isEmpty() || airline.isEmpty() || depPort.isEmpty() || depDate.isEmpty() || arrPort.isEmpty() || arrDate.isEmpty() || duration.isEmpty() || planeid.isEmpty() || stops.isEmpty()){
		...
		String insert = "INSERT INTO FlightDetails" +
		"(departureThreeLetterId, depDate, arrivalThreeLetterId, arrDate, duration , planeID, numOfStops, flightNum, twoLetterId) VALUES (?,?,?,?,?,?,?,?,?)";

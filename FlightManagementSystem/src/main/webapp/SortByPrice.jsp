...
<html>
	...
	<body>
		...
		try {
			...
			String str = "SELECT *,(SELECT MIN(farePrice) FROM FlightTicketTransaction f, RelatesTo r " +
             "WHERE f.ticketid = r.ticketid AND r.flightNum = FlightDetails.flightNum AND f.username IS NULL) AS minFarePrice " +
             "FROM FlightDetails ORDER BY CASE WHEN minFarePrice IS NULL THEN 1 ELSE 0 END, minFarePrice";

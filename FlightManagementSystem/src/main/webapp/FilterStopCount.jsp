...
<html>
	...
	<body>
		...
		try {
			...
			String stopCount = request.getParameter("stopCount");
			...
			String str = "SELECT * FROM FlightDetails WHERE numOfStops = ? AND depDate > ? ORDER BY numOfStops";
			PreparedStatement ps1 = con.prepareStatement(str);

			ps1.setInt(1, Integer.parseInt(stopCount));

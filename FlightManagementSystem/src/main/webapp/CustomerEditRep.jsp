...
<html>
	...
	<body>
		...
		<%} else {
		%>
		Reserve Flight for Customer
		<form action="flightReserveRep.jsp" method="POST">
		...
		<br/>
		<br/>
		Cancel Flight for Customer
		<form action="flightCancelRep.jsp" method="POST">
			Username: <input type="text" name="username"/> <br/>
			TicketID: <input type="text" name="ticketNum"/> <br/>
			<input type="submit" value="Submit"/><br/>
		</form>
		...
		try {
			...
			String str = "SELECT * From FlightTicketTransaction f, RelatesTo r WHERE f.ticketid = r.ticketid";
